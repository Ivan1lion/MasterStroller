...
async def cmd_privacy(message: Message):
    await message.answer(f'Этот документ описывает политику конфиденциальности для бота @MasterStroller_Bot '
                         ...
                         f'\nДанные хранятся на сервере 24 часа или до остановки бота. После чего данные удаляются'
                         ...
                         f'(продавцам запчастей), а именно вашего номера телефона и Username. Это необходимо для того '
                         f'что бы продавцы могли связаться с вами и предложить свой товар'
